...
- [Variables and Logic](#variables-and-logic)
    - [How do I alter variables and other game stats in-text?](#how-do-i-alter-variables-and-other-game-stats-in-text)
    - [Finding the biggest number out of a bunch of numbers. (Min & Max)](#finding-the-biggest-number-out-of-a-bunch-of-numbers-min--max)
    - [Storing Diverts in Variables](#storing-diverts-in-variables)
    - [Variables can store (and call!) functions](#variables-can-store-and-call-functions)
    - [Assigning conditional text based on numbers (switch statements!)](#assigning-conditional-text-based-on-numbers-switch-statements)
  - [String Manipulation made Easy](#string-manipulation-made-easy)
  - [Miscellaneous Variables Tips](#miscellaneous-variables-tips)
    - [Variable declarations can be written anywhere](#variable-declarations-can-be-written-anywhere)
- [Lists](#lists)
    - [What are Lists?](#what-are-lists)
    - [So why are Ink Lists useful?](#so-why-are-ink-lists-useful)
    - [Is it possible to learn this power?](#is-it-possible-to-learn-this-power)
    - [A Basic State Machine using Lists (TODO: write explanation for example)](#a-basic-state-machine-using-lists-todo-write-explanation-for-example)
    - [A basic item properties system using Lists](#a-basic-item-properties-system-using-lists)
    - [Getting the Length of a List](#getting-the-length-of-a-list)
  - [A useful list popper construction](#a-useful-list-popper-construction)
- [-> Tunnels ->](#--tunnels--)
  - [Tunnels vs Threads](#tunnels-vs-threads)
    - [Why use Tunnels?](#why-use-tunnels)
    - [You can divert out of tunnels](#you-can-divert-out-of-tunnels)
    - [Threading Tunnels - threading content that's been written as a tunnel](#threading-tunnels---threading-content-thats-been-written-as-a-tunnel)
- [<-Threads (UNDER CONSTRUCTION)](#-threads-under-construction)
  - [Why use threads?](#why-use-threads)
    - [What ARE threads?](#what-are-threads)
- [Useful Design Patterns (UNDER CONSTRUCTION)](#useful-design-patterns-under-construction)
  - [Hubs](#hubs)
    - [Hubs - Looping through Choices until you escape](#hubs---looping-through-choices-until-you-escape)
    - [When you should use loops](#when-you-should-use-loops)
    - [Structuring Rooms into "Chunks of Interactivity" with Threads (UNDER CONSTRUCTION)](#structuring-rooms-into-chunks-of-interactivity-with-threads-under-construction)
    - [Once-only Diverts (UNDER CONSTRUCTION)](#once-only-diverts-under-construction)
    - [Dynamic Choices in Hubs](#dynamic-choices-in-hubs)
- [Patterns that create the illusion of a persistent world](#patterns-that-create-the-illusion-of-a-persistent-world)
    - [How to rig up content that only happens once (or at random)](#how-to-rig-up-content-that-only-happens-once-or-at-random)
    - [Defensive Logic Design (TODO)](#defensive-logic-design-todo)
- [Patterns for introducing variation and "randomness"](#patterns-for-introducing-variation-and-randomness)
    - [Dice Roll Pattern](#dice-roll-pattern)
    - [Using a function to randomly set a variable](#using-a-function-to-randomly-set-a-variable)
    - [Adding variation to repeated choices - aka stable shuffling with choice text](#adding-variation-to-repeated-choices---aka-stable-shuffling-with-choice-text)
    - [Structuring Big Chunks of Randomness](#structuring-big-chunks-of-randomness)
- [Implementing Meta-Structures (UNDER CONSTRUCTION)](#implementing-meta-structures-under-construction)
    - [Implementing "Groundhog Day" style time loops - "New Game +"](#implementing-groundhog-day-style-time-loops---new-game-)
- ["Query" patterns (UNDER CONSTRUCTION)](#query-patterns-under-construction)
    - [Database Functions](#database-functions)
    - [Multiple Conditionals across Multiple Lines](#multiple-conditionals-across-multiple-lines)
    - [Taking a Value and Returning a Divert](#taking-a-value-and-returning-a-divert)
- [Reacting to game-state and generating procedural text](#reacting-to-game-state-and-generating-procedural-text)
  - [Tracking and Reacting to what the player's experienced](#tracking-and-reacting-to-what-the-players-experienced)
    - [Tracking Knots!](#tracking-knots)
    - [Tracking in more detail - Stitches and Labels (UNDER CONSTRUCTION)](#tracking-in-more-detail---stitches-and-labels-under-construction)
    - [Tracking Choices](#tracking-choices)
    - [Advanced tracking: visit counts](#advanced-tracking-visit-counts)
    - [Advanced tracking: Turns since visiting a piece of content (UNDER CONSTRUCTION)](#advanced-tracking-turns-since-visiting-a-piece-of-content-under-construction)
    - [Using visit counts with knots and labels is a little different](#using-visit-counts-with-knots-and-labels-is-a-little-different)
    - [Commenting on game state in an exhaustive manner](#commenting-on-game-state-in-an-exhaustive-manner)
    - [Creating relationships by pairing list items together (UNDER CONSTRUCTION)](#creating-relationships-by-pairing-list-items-together-under-construction)
    - [Dynamically assigning pronouns (UNDER CONSTRUCTION)](#dynamically-assigning-pronouns-under-construction)
  - [Multiline Conditional Blocks](#multiline-conditional-blocks)
- [Keeping your script tidy and writing Ink efficiently](#keeping-your-script-tidy-and-writing-ink-efficiently)
    - [Why you might need this section](#why-you-might-need-this-section)
    - [Separating your Ink files with Include](#separating-your-ink-files-with-include)
  - [Using (and abusing) Inky's Autocomplete/Intellisense to make writing easier](#using-and-abusing-inkys-autocompleteintellisense-to-make-writing-easier)
    - [Using Autocomplete to help you remember knots and variable names](#using-autocomplete-to-help-you-remember-knots-and-variable-names)
    - [Hacking Intellisense to provide autocompletion for tags](#hacking-intellisense-to-provide-autocompletion-for-tags)
    - [Adopting good name-spacing practices](#adopting-good-name-spacing-practices)
  - [Organising lots of conditionals neatly (UNDER CONSTRUCTION)](#organising-lots-of-conditionals-neatly-under-construction)
  - [Why use stitches?](#why-use-stitches)
- [Testing your Game](#testing-your-game)
    - [Making random things less random - setting RNG seeds](#making-random-things-less-random---setting-rng-seeds)
    - [Unit Testing](#unit-testing)
    - [Testing by bashing randomly through your game with a javascript prototype (UNDER CONSTRUCTION)](#testing-by-bashing-randomly-through-your-game-with-a-javascript-prototype-under-construction)
- [Tips related to running your ink and front-end stuff (with JS, Unity, etc.)](#tips-related-to-running-your-ink-and-front-end-stuff-with-js-unity-etc)
    - [Can I display greyed-out/locked choices that aren't currently possible?](#can-i-display-greyed-outlocked-choices-that-arent-currently-possible)
    - [Fading prior text when working with javascript (UNDER CONSTRUCTION)](#fading-prior-text-when-working-with-javascript-under-construction)
    - [Can you can sneak css into the ink file itself? (UNDER CONSTRUCTION)](#can-you-can-sneak-css-into-the-ink-file-itself-under-construction)
    - [Saving and Loading Content externally](#saving-and-loading-content-externally)
    - [When to use tags vs when to use external functions](#when-to-use-tags-vs-when-to-use-external-functions)
    - [Manipulating Upper and Lower Case printing for Variables](#manipulating-upper-and-lower-case-printing-for-variables)
    - [Parsing and displaying dialogue](#parsing-and-displaying-dialogue)
  - [C#/Unity Stuff](#cunity-stuff)
    - [Is it possible to reach inside Ink and toggle a LIST value from C#?](#is-it-possible-to-reach-inside-ink-and-toggle-a-list-value-from-c)
    - [Debugging in Unity](#debugging-in-unity)
    - [What to do instead of lookaheads](#what-to-do-instead-of-lookaheads)
  - [Using buffering for your text boxes](#using-buffering-for-your-text-boxes)
- [Other Miscellaneous Tips](#other-miscellaneous-tips)
